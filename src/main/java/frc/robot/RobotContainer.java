...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        new JoystickButton(operator, JoystickConstants.START_BUTTON).onTrue(new SetIntakeWristPosition(.01, 0, 0, 0.5, -0.4301)); //Up Position
        new JoystickButton(operator, JoystickConstants.BACK_BUTTON).onTrue(new SetIntakeWristPosition(.01, 0, 0, 1.0, -6.2260)); // Down Position
    }
